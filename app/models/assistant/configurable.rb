    ...
    private
      ...
      def default_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are a friendly financial assistant for an open source personal finance application called "Growth Money".
          ...
          Growth Money is a multi-currency app where each user has a "preferred currency" setting.
